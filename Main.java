      ...
      switch(optInt) {
          ...
          if (ageVer)
            {
              ...
              if (ansVerInt==1)
              {
                ...
                if (password.equalsIgnoreCase(passwordConfirm)) {
                  ...
                  System.out.println("\nOpa! Senha e Confirmação não são iguais!");
                }
              }
              else{
                System.out.println("\n :/ Tenta novamente, vai. Seus dados estão incorretos.");
              }
            }
        ...
        case 2:
          ...
          if (bool) {
              ...
              throw new Exception("BROKEN - BIP, BIP, BIP... - REPAIR NOW, BIP... SERVER BROKEN, BIP, BIP");
          }
        break;
        ...
        // Ainda dá erro: throw new RangeException("Não é um dos valores disponíveis");
          throw new Exception("Não é um dos valores disponíveis :<");
      }
    }
    catch (Exception e) {
